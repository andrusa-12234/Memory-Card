...
questions_list.append(Question('До того, как была открыта гора Эверест, какая года была самой высокой в мире?', 'Эверест', 'Иордания', 'Уральские', 'Иртыш'))
questions_list.append(Question('Представь, что ты падаешь в яму полную ядовитых змей. Как выжить?', 'Перестать воображать', 'Ты труп', 'Не падать', 'Люблю змей'))
questions_list.append(Question('Что пренадлежит  тебе, но чаще это используют другие?','Твоё имя', 'Твой телефон', 'Тебя', 'Твоя одежда'))
questions_list.append(Question('Футболист пинает мяч на 20 метров, но он возвращается через 10 секнд. Как такое возможно?','Пинает вверх', 'Мяч не настоящий', 'Мяч квадратный', 'Ну не вовезло'))
questions_list.append(Question('Что может лечить и убивать человека, не касаясь его?','Время', 'Девушка', 'Деньги', 'Тёща'))
questions_list.append(Question('Как зовут жену, которая всегда знает где её муж?','Вдова', 'Девушка', 'Маша', 'Курица'))
questions_list.append(Question('Какой рукой лучше размешивать чай?','Лучше ложкой', 'Левой', 'Правой', 'Ногами'))
